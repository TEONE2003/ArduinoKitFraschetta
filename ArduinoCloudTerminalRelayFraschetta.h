...
public: ArduinoCloudTerminalRelayF(String *ReceivedString,bool *Readable,String Tag,uint8_t Pin,DigitalType Type=NormalLogic):BasicTerminalRelayF(ReceivedString,Readable,Tag,Pin,Type){}
};
#endif
#else
