...
public:
 ...
 void PASSI_A_DESTRA(uint16_t PASSI){for(uint16_t P=POSIZIONE_CORRENTE(); P<=PASSI; P++){PASSO_A_DESTRA();}}
 void PASSI_A_SINISTRA(uint16_t PASSI){for(uint16_t P=POSIZIONE_CORRENTE(); P>=PASSI; P--){PASSO_A_SINISTRA();}}
