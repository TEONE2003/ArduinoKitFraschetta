...
class SERIALE:public SoftwareSerial{
private:
String S;
boolean I;
uint16_t BAUD;
...
class OROLOGIO_VIRTUALE:public CRONOMETRO{
ORARIO O;
...
class CICLO_TIMER:public TIMER{
public:
...
class PULSANTE:public ENTRATA,public CICLO_TIMER{
 protected:
...
class FOTORESISTORE:public ENTRATA,public CICLO_TIMER {
protected:
...
class CREPUSCOLARE:public RELE,public FOTORESISTORE{
public:
...
class SERVOMOTORE:public Servo,public MOTORE_SWIPING{
 protected:
    uint8_t PIN;
...
class SERVO_INGRESSO:public SERVOMOTORE,public INGRESSO_MOTORIZZATO{
  protected:
...
class MOTORE_STEPPER_BASE:public MOTORE_SWIPING{
protected:
...
class MOTORE_STEPPER_4_BOBINE:public Stepper,public MOTORE_STEPPER_BASE{
  public:
...
class STEPPER_INGRESSO_BASE:public MOTORE_STEPPER_BASE,public INGRESSO_MOTORIZZATO {
   public:
    virtual uint16_t POSIZIONE_CORRENTE()=0;
    void APRI() override {
     MEMORIZZA_STATO(APERTURA);
    ...
    STEPPER_INGRESSO_BASE(uint16_t PASSI_MASSIMI,uint8_t VELOCITA,uint16_t INDIRIZZO_POSIZIONE_EEPROM):MOTORE_STEPPER_BASE(PASSI_MASSIMI,VELOCITA,INDIRIZZO_POSIZIONE_EEPROM){}
};
...
public:
    ...
    STEPPER_INGRESSO(uint8_t PIN_CONTROLLO_PASSO,uint8_t PIN_VERSO, boolean STATO_PIN_VERSO_DESTRA,uint16_t PASSI_MASSIMI,uint16_t INDIRIZZO_POSIZIONE_EEPROM,
    uint8_t VELOCITA,uint16_t PASSI_APERTURA,uint16_t PASSI_CHIUSURA,uint16_t INDIRIZZO_POSIZIONE_STATO_DEL_MOVIMENTO):
    STEPPER_INGRESSO_BASE(PASSI_MASSIMI,VELOCITA,INDIRIZZO_POSIZIONE_EEPROM){
     IMPOSTA_VELOCITA(VELOCITA);
...
class STEPPER_INGRESSO_4_BOBINE:public MOTORE_STEPPER_4_BOBINE,public STEPPER_INGRESSO_BASE{
  public:
    ...
    MOTORE_STEPPER_4_BOBINE(PASSI_MASSIMI,VELOCITA,PIN_BOBINA1,PIN_BOBINA2,PIN_BOBINA3,PIN_BOBINA4,INDIRIZZO_POSIZIONE_EEPROM),
    STEPPER_INGRESSO_BASE(PASSI_MASSIMI,VELOCITA,INDIRIZZO_POSIZIONE_EEPROM){
     FINECORSA_APERTURA = PASSI_APERTURA;
     FINECORSA_CHIUSURA = PASSI_CHIUSURA;
     INGRESSO_MOTORIZZATO::INDIRIZZO_POSIZIONE_STATO_DEL_MOVIMENTO = INDIRIZZO_POSIZIONE_STATO_DEL_MOVIMENTO;
