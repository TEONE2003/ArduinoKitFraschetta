...
public:
   ...
   INGRESSO_MONITORATO(uint16_t FINECORSA_APERTURA,uint16_t FINECORSA_CHIUSURA){
    this->FINECORSA_APERTURA = POSIZIONE_APERTURA;
    this->FINECORSA_CHIUSURA = POSIZIONE_CHIUSURA;
    }
   INGRESSO_MONITORATO(){}
};
...
class STEPPER_INGRESSO_BASE:MOTORE_STEPPER_BASE,INGRESSO_MOTORIZZATO {
   public:
    virtual uint16_t POSIZIONE_CORRENTE()=0;
    void APRI() override {
     MEMORIZZA_STATO(APERTURA);
...
public:
    ...
    STEPPER_INGRESSO_BASE(PASSI_MASSIMI,VELOCITA,PIN_CONTROLLO_PASSO,PIN_VERSO){
     IMPOSTA_VELOCITA(VELOCITA);
...
class STEPPER_INGRESSO_4_BOBINE:public MOTORE_STEPPER_4_BOBINE,public STEPPER_INGRESSO_BASE{
  public:
    ...
    STEPPER_INGRESSO_BASE(PASSI_MASSIMI,VELOCITA,PIN_BOBINA2,PIN_BOBINA3){CONTROLLO_STATO_MOVIMENTO();}
};
