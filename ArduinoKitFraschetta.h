...
TEMPO CONVERTITO_IN(UNITA_DI_TEMPO UNITA){
 uint64_t VAL=0;
switch(UNITA){
 case UNITA_DI_TEMPO::NANOSECONDI: VAL = NANOSECONDI(); break;
 case UNITA_DI_TEMPO::MICROSECONDI: VAL = MICROSECONDI(); break;
 case UNITA_DI_TEMPO::MILLISECONDI: VAL = MILLISECONDI(); break;
 case UNITA_DI_TEMPO::SECONDI: VAL = SECONDI(); break;
 case UNITA_DI_TEMPO::MINUTI: VAL = MINUTI(); break;
 case UNITA_DI_TEMPO::ORE: VAL = ORE(); break;
 case UNITA_DI_TEMPO::GIORNI: VAL = GIORNI(); break;
 case UNITA_DI_TEMPO::SETTIMANE: VAL = SETTIMANE(); break;
 case UNITA_DI_TEMPO::MESI_COMMERCIALI: VAL = MESI_COMMERCIALI(); break;
 case UNITA_DI_TEMPO::ANNI: VAL = ANNI(); break;
 case UNITA_DI_TEMPO::ANNI_COMMERCIALI: VAL = ANNI_COMMERCIALI(); break;
}
...
CRONOMETRO(UNITA_DI_TEMPO UNITA=MILLISECONDI){IMPOSTA_UNITA_DI_TEMPO(UNITA); TI = TEMPO(0,MICROSECONDI); TEMPO_PASS=TI; MICROSECONDI_ATTUALI=0; CRONOMETRO_ATTIVO=0;}
...
TIMER(uint64_t PERIODO=0,UNITA_DI_TEMPO UNITA=MILLISECONDI):CRONOMETRO(UNITA){IMPOSTA_PERIODO_E_UNITA_DI_TEMPO(PERIODO,UNITA); T_INIZIALIZZATO=1;}
TIMER(uint64_t PERIODO=0,UNITA_DI_TEMPO UNITA=MILLISECONDI, TIPO_TIMER TIPO=NON_BLOCCANTE):TIMER(PERIODO,UNITA){IMPOSTA_TIPO_TIMER(TIPO);}
};

class CICLO_TIMER:CRONOMETRO{
public:
 CICLO_TIMER(uint64_t PERIODO,UNITA_DI_TEMPO UNITA):CRONOMETRO(UNITA){}
 CICLO_TIMER(uint64_t PERIODO,UNITA_DI_TEMPO UNITA,TIPO_TIMER TIPO):CRONOMETRO(UNITA){}
 CICLO_TIMER():CRONOMETRO(){}
