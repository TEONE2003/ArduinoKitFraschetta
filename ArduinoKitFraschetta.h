...
public:
    static struct EEPROM_UINT16_T(){
        ...
        void IMPOSTA_VALORE(uint16_t N){
...
public:
 ...
 void PASSI(uint16_t PASSI){PASSI_A_DESTRA(PASSI); PASSI_A_SINISTRA(PASSI);}
 void SWIPE_AVANTI() override {PASSI(GRADI_AVANTI);}
 void SWIPE_INDIETRO() override {PASSI(GRADI_INDIETRO);}
...
protected:
 uint8_t PIN_1,PIN_2,PIN_3,PIN_4;
public:
...
class STEPPER_INGRESSO_BASE:MOTORE_STEPPER_BASE,public INGRESSO_MOTORIZZATO{
 public:
  ...
  uint16_t PERIODO_SPOSTAMENTO_IN_MILLISECONDI,uint16_t INDIRIZZO_POSIZIONE_EEPROM,uint16_t INDIRIZZO_POSIZIONE_STATO_DEL_MOVIMENTO):
   MOTORE_STEPPER_BASE(PASSI_MASSIMI,PERIODO_SPOSTAMENTO_IN_MILLISECONDI,INDIRIZZO_POSIZIONE_EEPROM),
...
class STEPPER_INGRESSO:MOTORE_STEPPER,public STEPPER_INGRESSO_BASE{
 public:
  ...
  uint16_t PERIODO_SPOSTAMENTO_IN_MILLISECONDI,uint16_t PASSI_APERTURA,uint16_t PASSI_CHIUSURA):
  STEPPER_INGRESSO_BASE(PASSI_MASSIMI,PASSI_APERTURA,PASSI_CHIUSURA,PERIODO_SPOSTAMENTO_IN_MILLISECONDI,PIN_CONTROLLO_PASSO,PIN_CONTROLLO_PASSO+2),
 ...
 public:
  void CONTROLLO_STATO_MOVIMENTO(){STEPPER_INGRESSO_BASE::CONTROLLO_STATO_MOVIMENTO();}
   uint16_t POSIZIONE_CORRENTE() override {return MOTORE_STEPPER_BIPOLARE::POSIZIONE_CORRENTE();}
    STEPPER_INGRESSO_BIPOLARE(uint16_t PASSI_MASSIMI,uint8_t PIN_1,uint8_t PIN_2,uint8_t PIN_3,uint8_t PIN_4,
   uint16_t PASSI_APERTURA,uint16_t PASSI_CHIUSURA,uint8_t PERIODO_SPOSTAMENTO_IN_MILLISECONDI):
    MOTORE_STEPPER_BIPOLARE(PASSI_MASSIMI,PERIODO_SPOSTAMENTO_IN_MILLISECONDI,PIN_1,PIN_2,PIN_3,PIN_4),
   STEPPER_INGRESSO_BASE(PASSI_MASSIMI,PASSI_APERTURA,PASSI_CHIUSURA,PERIODO_SPOSTAMENTO_IN_MILLISECONDI,PIN_1,PIN_3){}
};
