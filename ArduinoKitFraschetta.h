...
class STEPPER_INGRESSO_BASE:MOTORE_STEPPER,public INGRESSO_MOTORIZZATO {
   public:
    virtual uint16_t POSIZIONE_CORRENTE();
    void APRI() override {
     MEMORIZZA_STATO(APERTURA);
    ...
    boolean APERTO() override {return POSIZIONE_CORRENTE()==FINECORSA_APERTURA;}
    boolean CHIUSO() override {return POSIZIONE_CORRENTE()==FINECORSA_CHIUSURA;}
    void IMPOSTA_VELOCITA(){MOTORE_STEPPER::IMPOSTA_VELOCITA();}
    STEPPER_INGRESSO_BASE(uint8_t PIN_CONTROLLO_PASSO,uint8_t PIN_VERSO, boolean STATO_PIN_VERSO_DESTRA, uint16_t PASSI_MASSIMI,uint16_t INDIRIZZO_POSIZIONE_EEPROM,uint8_t VELOCITA):MOTORE_STEPPER(PIN_CONTROLLO_PASSO,PIN_VERSO,STATO_PIN_VERSO_DESTRA,PASSI_MASSIMI,INDIRIZZO_POSIZIONE_EEPROM,VELOCITA){}
};
...
public:
    ...
    STEPPER_INGRESSO_BASE(PIN_CONTROLLO_PASSO,PIN_VERSO,STATO_PIN_VERSO_DESTRA,PASSI_MASSIMI,INDIRIZZO_POSIZIONE_EEPROM,VELOCITA){
     IMPOSTA_VELOCITA(VELOCITA);
