...
public: DefaultSerial1DhtF(String Tag,uint8_t Pin,uint8_t Type,String *ReceivedString,bool *Readable):BasicSerialDhtF(Tag,Pin,Type,ReceivedString,Readable),DefaultSerial1F(){}
