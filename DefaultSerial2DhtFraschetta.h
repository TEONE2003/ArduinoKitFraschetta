...
public: DefaultSerial2DhtF(String *ReceivedString,bool *Readable,String Tag,uint8_t Pin,uint8_t Type):BasicSerialDhtF(Tag,Pin,Type,ReceivedString,Readable),DefaultSerial2F(){}
