...
public:
 DefaultSerial2RelayF(String Tag,uint8_t Pin,DigitalType Type=NormalLogic,MemorizeStatus Save=DoNotSaveStatus,long Baud=9600,ReceivedString):BasicTerminalRelayF(Tag,Pin,Type,Save,ReceivedString),DefaultSerial2F(Baud){}
