...
public: SerialDhtF(String Tag,uint8_t Pin,uint8_t Type,uint8_t Rx=2,uint8_t Tx=3,String *ReceivedString,bool *Readable):BasicSerialDhtF(Tag,Pin,Type,ReceivedString,Readable),SerialF(Rx,Tx){}
