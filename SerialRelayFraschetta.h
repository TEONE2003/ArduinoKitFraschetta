...
public: SerialRelayF(String Tag,uint8_t Pin,DigitalType Type=NormalLogic,MemorizeStatus Save=DoNotSaveStatus,uint8_t Rx=2,uint8_t Tx=3,String *ReceivedString):BasicTerminalRelayF(Tag,Pin,Type,Save,ReceivedString),SerialF(Rx,Tx){}
