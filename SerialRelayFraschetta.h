...
public: SerialRelayF(String *ReceivedString,bool *Readable,String Tag,uint8_t Pin,DigitalType Type=NormalLogic,MemorizeStatus Save=DoNotSaveStatus,uint8_t Rx=2,uint8_t Tx=3):BasicTerminalRelayF(ReceivedString,Readable,Tag,Pin,Type,Save),SerialF(Rx,Tx){}
