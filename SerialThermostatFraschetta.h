...
public:
 SerialThermostatF(String *ReceivedString,bool *Readable,String Tag,uint8_t PinRele,DigitalType ReleType=NormalLogic,ThermostatType TypeT=Heating,uint8_t Rx=2,uint8_t Tx=3):BasicTerminalThermostatF(Tag,PinRele,ReleType,TypeT,ReceivedString,Readable),SerialF(Rx,Tx){}
